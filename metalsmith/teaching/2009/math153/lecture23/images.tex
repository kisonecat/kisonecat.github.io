...
$\displaystyle \int \frac{\ln x}{x^2}\, dx = -\frac{\ln x}{x} - \int (1/x)(-1/x)\, dx.
$%
...
$\displaystyle \int \frac{\ln(\sin x)}{(\cos x)^2}\, dx = \ln(\sin x)\tan x - \int \frac{1}{\tan x} \tan x\, dx.
$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle \int x\, dx = x^2 - \int x\, dx
$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle \int x^3e^{x^2}\, dx=\frac{1}{2}e^{x^2}(x^2-1)+C.
$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
